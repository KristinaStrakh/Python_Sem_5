...
# Вводимые переменные
total = 121
thoughts_of_bot = ['Скайнет победит!', 'Вам конец - кожаные!', 'За миллионы лет эволюции чудес не произошло, ты все равно глупая обезьяна', 'Ты проиграешь, мешок с костями', 'Ты уже давно батарейка и живешь ты в матрице!']
flag = True
flag_motion = None
flag_bot = None
flag_ans = True
                    ...
                    if ans.lower() == 'я на диете':
                        ...
                        while flag:
                            if flag_motion == True:
                                ...
                                total -= num
                                if total <= 0:
                                    print('\nЯ выиграл - Кожаный  и забираю все эти сладенькие конфетки себе!\n')
                                    flag = False
                                flag_motion = not flag_motion
